...
const Page = () => {
  return (
    <div className="max-w-2xl bg-white bg-opacity-70 mx-2 mt-14 p-6 rounded-md shadow-md">
      ...
      <p className="text-gray-700 mb-4">
        Kami mengajak Anda bergabung dengan komunitas kami dan tetap terinformasi tentang konsumenisme yang bertanggung jawab. Dengan berbagi informasi, meningkatkan kesadaran, dan membuat pilihan etis bersama-sama, kita dapat berkontribusi
        pada dunia yang lebih berkelanjutan dan adil.
      </p>
